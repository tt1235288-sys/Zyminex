...
export const metadata: Metadata = {
  ...
  title: {
    default: `Zyminex IPTV - 30,000+ Channels & Full HD/4K Sports`,
    template: `%s | ${CONSTANTS.BRAND_NAME}`,
  },
  description: `Access 30,000+ live channels & 4K PPV sports on Zyminex IPTV. Enjoy 99.9% uptime, buffer-free streaming & multi-device instant setup.`,
  ...
  openGraph: {
    title: `Zyminex IPTV - 30,000+ Channels & Full HD/4K Sports`,
    description: `Access 30,000+ live channels & 4K PPV sports on Zyminex IPTV. Enjoy 99.9% uptime, buffer-free streaming & multi-device instant setup.`,
    url: SITE_URL,
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: `${CONSTANTS.BRAND_NAME} is a high-speed streaming platform that delivers live sports, PPV events, 30,000+ international TV channels, and 60,000+ movies directly over your internet connection without requiring satellite dishes or cable box hardware.`,
            },
          },
          {
            '@type': 'Question',
